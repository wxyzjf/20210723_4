/opt/etl/prd/etl/APP/ADW/C_RPT_SIMO_REV/bin> cat c_rpt_simo_rev0010.pl
######################################################
...
$dbcur->bind_param(1,D_SIMO_MKT_REF_H);
$dbcur->execute;
...
delete from ${etlvar::ETLDB}.ETL_RECEIVED_FILE where ETL_JOB='D_SIMO_MKT_REF_H';
delete from ${etlvar::ETLDB}.ETL_RECEIVED_FILE where ETL_JOB='D_SIMO_PREM_MKT_REF_H';
delete from ${etlvar::ETLDB}.ETL_RECEIVED_FILE where ETL_JOB='D_SIMO_PREM_BILL_REF_H';

update ${etlvar::ETLDB}.ETL_JOB set LAST_TXDATE=date'$update_job_status_date',LAST_JOBSTATUS='Ready' where ETL_JOB='D_SIMO_MKT_REF_H';
update ${etlvar::ETLDB}.ETL_JOB set LAST_TXDATE=date'$update_job_status_date',LAST_JOBSTATUS='Ready' where ETL_JOB='D_SIMO_PREM_MKT_REF_H';
update ${etlvar::ETLDB}.ETL_JOB set LAST_TXDATE=date'$update_job_status_date',LAST_JOBSTATUS='Ready' where ETL_JOB='D_SIMO_PREM_BILL_REF_H';
...
update ${etlvar::ETLDB}.ETL_SRC_FILE set LAST_PROCESS_START_TS=null where job_name='D_SIMO_MKT_REF_H';
update ${etlvar::ETLDB}.ETL_SRC_FILE set LAST_PROCESS_START_TS=null where job_name='D_SIMO_PREM_MKT_REF_H';
update ${etlvar::ETLDB}.ETL_SRC_FILE set LAST_PROCESS_START_TS=null where job_name='D_SIMO_PREM_BILL_REF_H';
...
if ($ret == 0){
        system("touch /opt/etl/prd/etl/preprocess/USR/rerun/d_simo_mkt_ref_h.rerun.'$touch_date' ");
        system("touch /opt/etl/prd/etl/preprocess/USR/rerun/d_simo_prem_mkt_ref_h.rerun.'$touch_date' ");
        system("touch /opt/etl/prd/etl/preprocess/USR/rerun/d_simo_prem_bill_ref_h.rerun.'$touch_date' ");
